      ...
      {result && (
        ...
        >
          ...
          {result.extended && (
            <div className="mt-3 text-xs leading-6 bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg p-2.5">
              <p className="text-amber-800 dark:text-amber-300 font-medium">
                ⚠ اليوم الأخير التقويمي ({formatDateAr(result.rawDeadline)}) يوافق{" "}
                {result.skippedHolidays.map((s) => s.name).join("، ")} — فيُمدّ
                إلى أوّل يوم عمل تالٍ.
              </p>
          ...
          <p className="text-xs text-muted mt-4 leading-6">
            ...
            (40) لسنة 2002م. تُراعى الحاسبة امتداد اليوم الأخير إن صادف جمعة/سبت
            أو عطلة رسمية (قانون العطل 2/2000) أو رمضان (العطلة القضائية — م.73
            سلطة قضائية). ملاحظات مهمة: العطلة القضائية شهران، الشهر الثاني منها
            يُحدَّد بقرار سنوي وليس محسوباً هنا؛ والعطل الهجرية تقريبية (أم القرى)؛
            وقد يتأثّر الميعاد ببدء الاحتساب ومسافة الطريق ووقف الميعاد قانوناً
            (المادة 277). النتيجة استرشادية — راجع المختصّ القانوني.
          </p>
        </div>
      )}
    </div>
